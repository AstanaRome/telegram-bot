...
- Ручное управление: либо кнопки «Добавить/Редактировать/Удалить» с пошаговым вводом, либо команды `/add_session`, `/edit_session`, `/delete_session`
...
ID отображаются в `/stats` (строки вида `1. #42 ...`). Те же действия можно выполнить через кнопки «➕ Добавить вручную», «✏️ Редактировать», «🗑 Удалить» — бот попросит нужные значения пошагово, а кнопка «❌ Отмена» отменит ввод.
